...
For my first milestone, I was able to create a prototype of my project by wiring the arduino with the buzzer, LED light, and ultrasonic sensor. How this project works is that the trigger pin in the ultrasonic sensor is programmed to repeatedly send out waves that hit objects and reflect back into the sensor. The echo pin of the sensor is supposed to record how long it takes for the waves to be sent out and reflected back. Using this time, I was able to figure out the distance of the object. This was done because it takes 29 microseconds for a wave to travel 1 cm, so by dividing the total duration by 29, and then by 2 to account for the wave having to travel to the object and back, I can figure out exactly how far the object is in cm. My buzzer and LED will light up when the object is less than 50 cm away. The delay between when the LED and buzzer turn on and off depends on the distance of the object. For example, if the object is closer, the distance will be smaller so there will be less delay so the LED and buzzer will turn on and off more frequently. Initially, the circuit diagram I was following was also using a swtich and a motor, but because I didn't have access to either of those things I had to work my way around that by not including them in my wiring. Another problem I had was that the circuit diagram initally had the LED light and buzzer attached to the 5 pin on the arduino. However, that caused my LED light to barely light up because the buzzer would take up most of the power. I fixed this by simply attaching my LED to the 6 pin instead and created a new variable for the new pin to represent the LED in my code. Another problem I ran into was that the circuit diagram I was using was for the adruino pro mini, but I was using the adruino micro. I had to figure out how to wire my project in a way so that it would work for my adruino micro. Because this is my first time working with electronics in this way, I am happy with my progress and how much I have learned in such a short period of time. For my next milestone I hope to add a camera to my project so I can get more detailed information about the objects my project is detecting rather than just distance. 
